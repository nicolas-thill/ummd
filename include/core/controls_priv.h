...
extern my_control_t *my_control_priv_create(my_control_conf_t *conf, size_t size);
extern void my_control_priv_destroy(my_control_t *control);

extern void my_control_register(my_control_impl_t *impl);
